...
func schemaOne(db *sql.DB) {
	...
	ExecQuery(db, "CREATE TABLE IF NOT EXISTS public.authors (id uuid DEFAULT uuid_generate_v4 (), bio TEXT, name VARCHAR(255), papers uuid [], psuedonym BOOL, created_at TIMESTAMPTZ, PRIMARY KEY (id));")
